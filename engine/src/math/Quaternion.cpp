...
{
    Quaternion result;
    float trace = mat.v11 + mat.v22 + mat.v33;
    ...
    if (trace > 0)
    {
        ...
        result.w = s / 2.0f;
        s = 0.5f / s;
        result.x = (mat.v32 - mat.v23) * s;
        result.y = (mat.v13 - mat.v31) * s;
        result.z = (mat.v21 - mat.v12) * s;
        return result;
    }
    else
    {
...
Matrix3 Quat2Matrix(const Quaternion &quat)
{
    ...
    result.v11 = 1 - 2 * qy2 - 2 * qz2;
    result.v21 = 2 * quat.x * quat.y + 2 * quat.w * quat.z;
    result.v31 = 2 * quat.x * quat.z - 2 * quat.w * quat.y;
    result.v12 = 2 * quat.x * quat.y - 2 * quat.w * quat.z;
    result.v22 = 1 - 2 * qx2 - 2 * qz2;
    result.v32 = 2 * quat.y * quat.z + 2 * quat.w * quat.x;
    result.v13 = 2 * quat.x * quat.z + 2 * quat.w * quat.y;
    result.v23 = 2 * quat.y * quat.z - 2 * quat.w * quat.x;
    result.v33 = 1 - 2 * qx2 - 2 * qy2;
    return result;
}
